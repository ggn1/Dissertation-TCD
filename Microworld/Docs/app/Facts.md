...
$$
CO_2 \text{ ppm} = \frac{V_c}{V_t}\times10^6
$$
Here, $V_c =$ volume of $CO_2$ $(m^3)$ and $V_t=$ volume of air $(m^2)$.
...
Given weight of carbon in the air and the volume of the atmosphere, the concentration of $CO_2$ in $PPM$ can be computed as in [[CO2 Concentration from Carbon Weight]].
...
* Then, this tree is around 500 kg dry mass and 500 kg water.
...
* With intensive berry picking, a group of people can harvest around $10 \text{ kg}$ of wild berries per year. [(M. Riedl et. al., 2020)](https://www.mdpi.com/1999-4907/11/10/1114)
